...
GSVPANO.PanoLoader = function (parameters) {
     ...
     * @type {String}
     */
    PANOLENS.DataImageSource = 'assets/img/';
    ...
    PANOLENS.DataImage = {
        ...
        pin_tl:             PANOLENS.DataImageSource + 'pin_tl.png',
        timeline:           PANOLENS.DataImageSource + 'timeline.png',
        // setas
...
PANOLENS.StereographicShader = {
	...
	PANOLENS.Panorama.prototype.link = function ( pano, position, imageScale, imageSrc, text_vem ) {
		...
		spot.addEventListener("hoverenter", function(){
			...
			// criado por mim Douglas, se passar pela seta, verifica se esta nulo, se nao vibra
	...
	*/
	 ...
	 */
	PANOLENS.Infospot = function ( scale, imageSrc, animated, mhover ) {
		...
		mhover = mhover !== undefined ? mhover : true;
